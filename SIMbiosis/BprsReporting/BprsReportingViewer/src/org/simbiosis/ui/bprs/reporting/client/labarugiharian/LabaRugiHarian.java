...
public class LabaRugiHarian extends FormWidget implements ILabaRugiHarian {

	Activity activity;

	private static MyUiBinder uiBinder = GWT.create(MyUiBinder.class);

	interface MyUiBinder extends UiBinder<Widget, LabaRugiHarian> {
	}
	...
	public void loadReport() {
		...
		String url = "/BprsReportingService/getLabaRugiHarian?" + strBranch + "&"
				+ strDate;
